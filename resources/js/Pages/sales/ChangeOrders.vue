<template>    
            ...
            <div class="col-sm-9">
                <div class="d-flex align-items-center justify-content-between gap-2" style="width: auto; float: right;" v-if="!updating">
                    ...
                    <div class="d-flex gap-2" v-if="selectedProposals.length != 0">
                        <a class="btn btn-primary-v2"  v-if="selectedProposals.length === 1" style="width: auto;" :style="{'cursor': updating ? 'not-allowed' : 'pointer'}" @click="handleChangeOrder">Change Order</a>
                    </div>
                </div>
    ...
    <div class="p-0" style="width: 100%; height: calc(100vh - 191px);">
        <div v-if="loading">
            <div class="col-md-12 d-flex flex-column align-items-center justify-content-center b-l-light " style="height: 100%; margin-top: 50px;">
                ...
                <a class="f-w-600 mt-1 mb-5">Retreiving approved proposals...</a>
            </div>
        </div>
        <div v-else-if="rowData.length === 0" class="d-flex justify-content-center align-items-center" style="width: 100%;">
            <div class="card m-0 shadow-sm d-flex flex-row align-items-center p-5 gap-4" style="border-radius: 10px;">
                ...
                <div>
                    <h3 class="f-50 f-w-800 text-primary m-0 p-0">Change Orders</h3>
                    <a class="f-20 f-w-600 text-primary" style="margin-top: -20px;">APPROVE PROPOSAL CHANGES</a>
...
export default {
    ...
    data(){
        const fileAddress = 'https://buildovate-development.s3.us-west-1.amazonaws.com/images/sales/';
