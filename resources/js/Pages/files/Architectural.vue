          ...
          <div class="file-content">
            <div class="card">
              <div class="card-header">
                <div class="">
                  <h5 class="text-muted d-inline">Architectural Drawings</h5>
              ...
              <div class="card-body file-manager overflow-y-auto overflow-x-hidden custom-scrollbar" style="max-height: 700px" v-if="gridView">
                <ul class="files" >
                  <li class="file-box mr-3 mb-2" v-for="file in architecturalFile">
              ...
              <div class="card-body file-manager">
                <div class="table-responsive" v-if="listView" style="max-height: 700px; min-height: auto">
                  <table class="table table-hover" >
                    ...
                    <tbody>
                    <tr v-for="file in architecturalFile" >
                ...
                <div class="card rounded">
                  ...
                  <div class="overflow-auto" >
                    ...
                    <div id="footer-display">
                      <div v-for="file in architecturalFile">
...
export default {
  ...
  props: ['architecturalFile', 'userFolder'],
  data() {
    return {
      showLoader: false,
      gridView: false,
      ...
      fileUpload: {
        file: '',
        'upload-file-from' : 'architectural'
      },
    }
  },
  methods: {
    ...
    toggleSelectAll() {
      this.selectedItems.selectedFileId = this.selectAll
          ? this.architecturalFile.map(item => item.user_file_upload_id)
          : [];
      this.$emit('selection-changed', this.selectedItems.selectedFileId);
    },
    checkSelectAllStatus() {
      this.selectAll = this.selectedItems.selectedFileId.length === this.architecturalFile.length;
    },
    deleteFile() {
      if (this.selectedItems.selectedFileId.length === 0) {
        toast.error('No file has been selected!')
  ...
  mounted() {
    // let selfie = this
    //
    // Dropzone.options.architecturalsFiles = {
    //   paramName: "file",
    //   maxFiles: 10,
    //   maxFilesize: 10,
    ...
    // };
    //
    // let dz = new Dropzone('#architecturalsFiles')
    //
