          ...
          <div class="file-content">
            <div class="card">
              <div class="card-header">
                <div class="">
                  <h5 class="text-muted d-inline">Contracts</h5>
              ...
              <div class="card-body file-manager overflow-y-auto overflow-x-hidden custom-scrollbar" style="max-height: 700px" v-if="gridView">
                <ul class="files" >
                  <li class="file-box mr-3 mb-2" v-for="file in contractsFile">
              ...
              <div class="card-body file-manager">
                <div class="table-responsive" v-if="listView" style="max-height: 700px; min-height: auto">
                  <table class="table table-hover" >
                    ...
                    <tbody>
                    <tr v-for="file in contractsFile" >
                ...
                <div class="card rounded">
                  ...
                  <div class="overflow-auto" >
                    ...
                    <div id="footer-display">
                      <div v-for="contract in contractsFile">
...
export default {
  ...
  props: ['contractsFile', 'userFolder'],
  data() {
    return {
      showLoader: false,
      gridView: false,
  ...
  methods: {
    ...
    toggleSelectAll() {
      this.selectedItems.selectedFileId = this.selectAll
          ? this.contractsFile.map(item => item.user_file_upload_id)
          : [];
      this.$emit('selection-changed', this.selectedItems.selectedFileId);
    },
    checkSelectAllStatus() {
      this.selectAll = this.selectedItems.selectedFileId.length === this.contractsFile.length;
    },
    deleteFile() {
      if (this.selectedItems.selectedFileId.length === 0) {
        toast.error('No file has been selected!')
  ...
  mounted() {
    console.log(this.contractsFile)
    // Dropzone.options.contractFiles = {
    //   paramName: "file",
    //   maxFiles: 10,
    //   maxFilesize: 10,
    ...
    // };
    //
    // let dz = new Dropzone('#contractFiles')
    //
