          ...
          <div class="file-content">
            <div class="card">
              <div class="card-header">
                <div class="">
                  <h5 class="text-muted d-inline">Inspections</h5>
              ...
              <div class="card-body file-manager overflow-x-hidden overflow-y-auto custom-scrollbar" style="max-height: 700px" v-if="gridView">
                <ul class="files" >
                  <li class="file-box mr-3 mb-2" v-for="file in inspectionFile">
              ...
              <div class="card-body file-manager">
                <div class="table-responsive" v-if="listView" style="max-height: 700px; min-height: auto">
                  <table class="table table-hover" >
                    ...
                    <tbody>
                    <tr v-for="file in inspectionFile" >
                ...
                <div class="card rounded">
                  ...
                  <div class="overflow-auto" >
                    ...
                    <div id="footer-display">
                      <div v-for="file in inspectionFile">
...
export default {
  ...
  props: ['inspectionFile', 'userFolder'],
  data() {
    return {
      showLoader: false,
      gridView: false,
  ...
  methods: {
    ...
    toggleSelectAll() {
      this.selectedItems.selectedFileId = this.selectAll
          ? this.inspectionFile.map(item => item.user_file_upload_id)
          : [];
      this.$emit('selection-changed', this.selectedItems.selectedFileId);
    },
    checkSelectAllStatus() {
      this.selectAll = this.selectedItems.selectedFileId.length === this.inspectionFile.length;
    },
    deleteFile() {
      if (this.selectedItems.selectedFileId.length === 0) {
        toast.error('No file has been selected!')
  ...
  mounted() {
    // let selfie = this
    //
    // Dropzone.options.inspectionFiles = {
    //   paramName: "file",
    //   maxFiles: 10,
    //   maxFilesize: 10,
    ...
    // };
    //
    // let dz = new Dropzone('#inspectionFiles')
    //
