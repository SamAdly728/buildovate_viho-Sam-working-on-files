          ...
          <div class="file-content">
            <div class="card">
              <div class="card-header">
                <div class="">
                  <h5 class="text-muted d-inline">Documents</h5>
              ...
              <div class="card-body file-manager overflow-x-hidden overflow-y-auto custom-scrollbar" style="max-height: 700px" v-if="gridView">
                <ul class="files" >
                  <li class="file-box mr-3 mb-2" v-for="file in documentFile">
                ...
                <div class="card rounded">
                  ...
                  <div class="overflow-auto" >
                    ...
                    <div id="footer-display">
                      <div v-for="file in documentFile">
...
export default {
  ...
  methods: {
    ...
    toggleSelectAll() {
      this.selectedItems.selectedFileId = this.selectAll
          ? this.documentFile.map(item => item.user_file_upload_id)
          : [];
      this.$emit('selection-changed', this.selectedItems.selectedFileId);
    },
    checkSelectAllStatus() {
      this.selectAll = this.selectedItems.selectedFileId.length === this.documentFile.length;
    },
    deleteFile() {
      if (this.selectedItems.selectedFileId.length === 0) {
        toast.error('No file has been selected!')
  ...
  mounted() {
    ...
    // };
    //
    // let dz = new Dropzone('#documentFiles')
    //
