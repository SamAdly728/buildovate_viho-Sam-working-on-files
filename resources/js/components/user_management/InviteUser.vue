<template>
  <div>
    ...
    <!--         aria-hidden="true">-->
    <!--      <div class="modal-dialog modal-lg zoomIn modal-dialog-centered" role="document" style="max-width: 1000px;">-->
    ...
    <!--              &lt;!&ndash; <div class="edit-profile"> &ndash;&gt;-->
    <!--              <div class="row p-3">-->
    <!--                <div class="col-xl-4">-->
    <!--                  <div class="card">-->
    ...
    <!--                          <select name="role_id" v-model="formData.role_id" class="form-control">-->
